    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-5 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('/images/Frame 1430105956.png')",
            left: '0',
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to left, var(--background) 0%, var(--background) 20%, rgba(13, 13, 13, 0.95) 40%, rgba(13, 13, 13, 0.7) 60%, rgba(13, 13, 13, 0.3) 80%, transparent 100%)'
          }}
        />
      </div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <motion.div
              ...
              className="lg:col-span-7 lg:col-start-6 inline-flex items-center gap-2 mb-8"
            >
